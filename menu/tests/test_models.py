...
class TestModels(unittest.TestCase):
    ...
    def test_diaaberto(self):
        u = Utilizador.objects.create(nome='Admin1', 
        email='admin1@admin.com', 
        telefone='978989829', 
        password='0afb00138d8e73348ec1fe41fd3d3a8fcbd90156b263bfa5791ba0e095f42cfc',
        validada=4)
        a = Administrador.objects.create(pk=u.pk)
        d = DiaAberto.objects.create(ano=2022, 
        descricao='Dia Aberto 2022!!!!!!!!!!',
        emaildiaaberto='dia@aberto.com',
        enderecopaginaweb='http://www.diaaberto.com',
        datadiaabertoinicio='2021-07-20', 
        datadiaabertofim='2021-07-24',
        datainscricaonasatividadesinicio='2021-06-25', 
        datainscricaonasatividadesfim='2021-06-30', 
        datapropostaatividadeinicio='2021-06-25', 
        datapropostaatividadesfim='2020-06-30', 
        administrador_utilizador_idutilizador=a, 
    ...
    def test_almoco(self):
        ...
        m = Menu.objects.create(menu='Menu do dia 30', 
        descricao='Sopa:Juliana e Sobremesa:Mousse', 
        campus_idcampus=c, horario_has_dia_id_dia_hora =dh, 
        nralmocosdisponiveis=200)
    ...
    def test_prato(self):
        ...
        campus_idcampus=c, horario_has_dia_id_dia_hora =dh, 
        nralmocosdisponiveis=200)
        p = Prato.objects.create(idprato =10000,
        tipo='Carne', 
        descricao='Carne de Porco à Alentejana',
        nralmocos=0, 
        menu_idmenu =m)
    ...
    def test_transporte(self):
        ...
        th = TransporteHasHorario.objects.create(transporte_idtransporte=t,
        origem=o, 
        destino=p, 
        horario_has_dia_id_dia_hora=dh, 
        n_passageiros = 20)
