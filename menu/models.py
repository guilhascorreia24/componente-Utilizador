...
class Disponibilidade(models.Model):
    colaborador_utilizador_idutilizador = models.OneToOneField(Colaborador, models.CASCADE, db_column='colaborador_Utilizador_idutilizador')  # Field name made lowercase.
    ...
    horario_hora1 = models.ForeignKey('Horario', models.CASCADE, db_column='horario_hora1', related_name='horario_hora1')
