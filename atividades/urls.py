...
urlpatterns = [
    ...
    path('info/<int:idActivity>/', atividades.info_atividade_view, name='ver_mais_atividade'),
    path('validar/<int:idActivity>/', atividades.validar_atividade_view, name='aceitar_atividade'),
    path('recusar/<int:idActivity>/', atividades.recusar_atividade_view, name='recusar_atividade'),
